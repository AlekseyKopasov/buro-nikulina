...
const build = gulp.series(clean, copy, sprite, gulp.parallel(compileMinStyles, compileMainMinScripts, pug, optimizePng, optimizeJpg, optimizeSvg));
const dev = gulp.series(clean, copy, sprite, gulp.parallel(compileMinStyles, compileMainMinScripts, pug, optimizePng, optimizeJpg, optimizeSvg), syncServer);
const start = gulp.series(clean, copy, sprite, gulp.parallel(compileStyles, compileMainScripts, pug), syncServer);
const nomin = gulp.series(clean, copy, sprite, gulp.parallel(compileStyles, compileMainScripts, pug, optimizePng, optimizeJpg, optimizeSvg));
